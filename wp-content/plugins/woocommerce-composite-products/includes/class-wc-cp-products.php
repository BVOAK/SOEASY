	...
	*/
	...
	public static function filter_available_variation( $variation_data, $product, $variation ) {
		...
		if ( ! empty( $filtered_component_option ) ) {
			...
			/**
			 * Filters the availability text for the summary.
			 *
			 * @since  10.3.0
			 *
			 * @param  string  $availability Availability text.
			 */
			$variation_data['availability_for_summary'] = apply_filters( 'woocommerce_composite_product_summary_availability_text', $filtered_component_option->get_availability()['availability'] ?? '' );
