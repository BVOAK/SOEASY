			...
			<div class="os_value">
				<div data-modifiers="in,not-in"<?php echo in_array( $modifier, array( 'in', 'not-in' ) ) ? '' : ' style="display:none;"'; ?>>
					...
					if ( false === $use_ajax ) {
						...
						$data_search_include = wp_json_encode(
							array(
						...
						?>
						<select name="<?php echo esc_attr( $post_name ); ?>[component_data][<?php echo esc_attr( $component_id ); ?>][]" class="sw-select2-search--products" multiple="multiple" style="width: 100%;" data-include="<?php echo wc_esc_json( $data_search_include ); ?>" data-limit="100" data-action="woocommerce_json_search_products_and_variations_in_component" data-action_version="8.0" data-placeholder="<?php echo esc_attr__( 'Search for products and variations&hellip;', 'woocommerce-composite-products' ); ?>">
						<?php
