 ...
 * Copyright: © 2012 Element Stark LLC.
...
class WC_Dynamic_Pricing {
	...
	public function __construct() {
		...
		/* Helper Functions */
		require path_join( $plugin_dir, 'functions.php' );

		add_action( 'init', array( $this, 'load_plugin_textdomain' ) );

		if ( is_admin() ) {
			require path_join( $plugin_dir, 'admin/admin-init.php' );

			//Include and boot up the installer.
			require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-installer.php' );
			WC_Dynamic_Pricing_Installer::init();
		}

		//Include additional integrations
		if ( wc_dynamic_pricing_is_groups_active() ) {
			require path_join( $plugin_dir, 'integrations/groups/groups.php' );
		}

		if ( wc_dynamic_pricing_is_memberships_active() ) {
			require path_join( $plugin_dir, 'integrations/memberships/memberships.php' );
		}

		//Paypal express
		require path_join( $plugin_dir, 'integrations/paypal-express.php' );
		require path_join( $plugin_dir, 'integrations/woocommerce-product-bundles.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-compatibility.php' );
	...
	public function load_front_end( $plugin_dir ) {
		...
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-product-addons-integration.php' );
		WC_Dynamic_Pricing_Product_Addons_Integration::register();

		//Include helper classes
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-context.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-counter.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-tracker.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-cart-query.php' );

		//Include the collectors.
		require path_join( $plugin_dir, 'classes/collectors/class-wc-dynamic-pricing-collector.php' );
		require path_join( $plugin_dir, 'classes/collectors/class-wc-dynamic-pricing-collector-category.php' );
		require path_join( $plugin_dir, 'classes/collectors/class-wc-dynamic-pricing-collector-category-inclusive.php' );

		//Include the adjustment sets.
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-adjustment-set.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-adjustment-set-category.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-adjustment-set-product.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-adjustment-set-totals.php' );
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-adjustment-set-taxonomy.php' );

		//The base pricing module.
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-module-base.php' );

		//Include the advanced pricing modules.
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-advanced-base.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-advanced-product.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-advanced-category.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-advanced-totals.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-advanced-taxonomy.php' );

		//Include the simple pricing modules.
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-simple-base.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-simple-product.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-simple-category.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-simple-membership.php' );
		require path_join( $plugin_dir, 'classes/modules/class-wc-dynamic-pricing-simple-taxonomy.php' );

		//Include the UX module - This controls the display of discounts on cart items and products.
		require path_join( $plugin_dir, 'classes/class-wc-dynamic-pricing-frontend-ux.php' );
